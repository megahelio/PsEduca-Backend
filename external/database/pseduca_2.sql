...
INSERT INTO pseduca.miembros (nombre, email, descripcion, link_aportaciones_externo, imagen)
VALUES ('Juan Luis Rodríguez Rodríguez', 'juanluisrr@uvigo.gal', 'Profesor Asociado en la Universidad de Vigo, Departamento de Psicología Evolutiva y Comunicación, área de Psicología de la Educación y miembro del Grupo de Investigación HI9-GiPEDUvi en el que desarrolla líneas de investigación relacionadas con los procesos cognitivos, atención a la diversidad y orientación educativa. Compagina su labor como Orientador Educativo en las etapas de Educación Infantil, Primaria y Secundaria.', 'https://orcid.org/0000-0003-4505-5278', 'a49b1132-d0de-4806-a6ea-657354282c33.jpg');
...
INSERT INTO pseduca.miembros (nombre, email, descripcion, link_aportaciones_externo, imagen)
VALUES ('Leire Pérez Pérez', 'leiperez@uvigo.gal', 'Alumna en el Programa de Ciencias de la Educación y del Comportamiento, profesora contratada interina en la Universidad de Vigo en el Departamento de Psicología Evolutiva y Comunicación y miembro del grupo de investigación HI9-GiPEDUvi. Imparte docencia en los grados de educación infantil y primaria, y  en el Máster en Necesidades Específicas de Apoyo Educativo. Actualmente, su investigación se centra en el análisis de los mecanismos subyacentes al rendimiento matemático.', null, null);
