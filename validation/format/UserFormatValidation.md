...
|---------------------------------|---------|-----------------|-------------------|----------------------------------------------------------------------------------|----------------------------|
| ID_MINIMO_F_KO                  | Usuario | nombre_usuario  | ADD, EDIT         | Validar que sea un número >= 0                                                   | null, "abc"                |
| ID_INVALIDO_F_KO                | Usuario | nombre_usuario  | GET, LIST, DELETE | Validar que es número positivo                                                   | null, "abc", "-10"         |
...
| NOMBRE_COMPLETO_MINIMO_F_KO     | Usuario | nombre_usuario  | ADD, EDIT         | Validar longitud mínima (mínimo 4 caracteres)                                    | null, "abc"                |
