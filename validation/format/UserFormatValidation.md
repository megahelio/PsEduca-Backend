...
| NOMBRE_USUARIO_CARACTERES_F_KO  | Usuario | nombre_usuario  | ADD, EDIT  | Validar caracteres (solo a-z, A-Z, -, _, 0-9, á, é, í, ó, ú)                | "maria@lopez"              |
...
| NOMBRE_COMPLETO_CARACTERES_F_KO | Usuario | nombre_completo | ADD, EDIT  | Validar caracteres (solo a-z, A-Z, -, _, 0-9, á, é, í, ó, ú, espacio, ª, º) | "maria@lopez"              |
...
| CONTRASENHA_CARACTERES_F_KO     | Usuario | contrasenha     | ADD, EDIT  | Validar caracteres (solo a-z, A-Z, -, _, 0-9, $, @, /, \)                   | "maria@lopez"              |
